 ...
 */
export declare enum ChatPushDisplayStyle {
    /**
 ...
 *    ```
 */
export declare class ChatPushConfig {
    /**
     * The device ID.
 ...
 */
export declare class ChatPushOption {
    /**
...
//# sourceMappingURL=ChatPushConfig.d.ts.map