...
exports.ChatVoiceMessageBody = exports.ChatVideoMessageBody = exports.ChatTextMessageBody = exports.ChatRoomMessagePriority = exports.ChatRecalledMessageInfo = void 0;
var _ErrorHandler = require("../__internal__/ErrorHandler");
var _Utils = require("../__internal__/Utils");
var _ChatError = require("./ChatError");
var _Factory = require("../__internal__/Factory");
/**
 * The conversation types.
 */
let ChatMessageChatType = exports.ChatMessageChatType = /*#__PURE__*/function (ChatMessageChatType) {
 ...
 */
let ChatMessageDirection = exports.ChatMessageDirection = /*#__PURE__*/function (ChatMessageDirection) {
 ...
 */
let ChatMessageStatus = exports.ChatMessageStatus = /*#__PURE__*/function (ChatMessageStatus) {
 ...
 */
let ChatDownloadStatus = exports.ChatDownloadStatus = /*#__PURE__*/function (ChatDownloadStatus) {
 ...
 * The message types.
 */
let ChatMessageType = exports.ChatMessageType = /*#__PURE__*/function (ChatMessageType) {
 ...
 */
let ChatRoomMessagePriority = exports.ChatRoomMessagePriority = /*#__PURE__*/function (ChatRoomMessagePriority) {
 ...
 */
let ChatMessagePinOperation = exports.ChatMessagePinOperation = /*#__PURE__*/function (ChatMessagePinOperation) {
 ...
 */
let ChatMessageSearchScope = exports.ChatMessageSearchScope = /*#__PURE__*/function (ChatMessageSearchScope) {
...
class ChatMessage {
  ...
  static createSendMessage(params) {
    let r = new ChatMessage({
      from: _Factory.Factory.getChatClient().currentUserName ?? '',
      body: params.body,
      direction: 'send',
      to: params.targetId,
      hasRead: true,
   ...
   */
  static createTextMessage(targetId, content, chatType = ChatMessageChatType.PeerChat, opt) {
   ...
   * @returns The message instance.
   */
  static createFileMessage(targetId, filePath, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
   ...
   * @returns The message instance.
   */
  static createImageMessage(targetId, filePath, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
      body: new ChatImageMessageBody({
        ...
        fileSize: opt === null || opt === void 0 ? void 0 : opt.fileSize,
        isGif: opt === null || opt === void 0 ? void 0 : opt.isGif
      }),
      targetId: targetId,
      chatType: chatType,
      isChatThread: opt === null || opt === void 0 ? void 0 : opt.isChatThread,
   ...
   * @returns The message instance.
   */
  static createVideoMessage(targetId, filePath, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
   ...
   * @returns The message instance.
   */
  static createVoiceMessage(targetId, filePath, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
   ...
   * @returns The message instance.
   */
  static createCombineMessage(targetId, messageIdList, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
   ...
   * @returns The message instance.
   */
  static createLocationMessage(targetId, latitude, longitude, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
   ...
   * @returns The message instance.
   */
  static createCmdMessage(targetId, action, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
   ...
   * @returns The message instance.
   */
  static createCustomMessage(targetId, event, chatType = ChatMessageChatType.PeerChat, opt) {
    return ChatMessage.createSendMessage({
   ...
   */
  get reactionList() {
    return _Factory.Factory.getChatClient().chatManager.getReactionList(this.msgId);
  }
   ...
   */
  get groupReadCount() {
    return _Factory.Factory.getChatClient().chatManager.groupAckCount(this.msgId);
  }
   ...
   */
  get threadInfo() {
    return _Factory.Factory.getChatClient().chatManager.getMessageThread(this.msgId);
  }
   ...
   */
  get getPinInfo() {
    return _Factory.Factory.getChatClient().chatManager.getMessagePinInfo(this.msgId);
  }
...
exports.ChatRecalledMessageInfo = ChatRecalledMessageInfo;
