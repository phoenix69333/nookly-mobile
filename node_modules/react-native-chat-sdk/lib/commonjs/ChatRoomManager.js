...
class ChatRoomManager extends _Native.Native {
  ...
  invokeRoomListener(params) {
    this._roomListeners.forEach(listener => {
      var _listener$onDestroyed, _listener$onMemberJoi, _listener$onMemberExi, _listener$onMemberRem, _listener$onMuteListR, _listener$onAdminAdde, _listener$onAdminRemo, _listener$onOwnerChan, _listener$onAnnouncem, _listener$onAllowList, _listener$onAllowList2, _listener$onAllChatRo, _listener$onSpecifica, _listener$onAttribute, _listener$onAttribute2;
      const contactEventType = params === null || params === void 0 ? void 0 : params.type;
      switch (contactEventType) {
        case 'onChatRoomDestroyed':
          (_listener$onDestroyed = listener.onDestroyed) === null || _listener$onDestroyed === void 0 || _listener$onDestroyed.call(listener, {
            roomId: params.roomId,
            roomName: params.roomName
          });
          break;
        case 'onMemberJoined':
          (_listener$onMemberJoi = listener.onMemberJoined) === null || _listener$onMemberJoi === void 0 || _listener$onMemberJoi.call(listener, {
            roomId: params.roomId,
          ...
          break;
        case 'onMemberExited':
          (_listener$onMemberExi = listener.onMemberExited) === null || _listener$onMemberExi === void 0 || _listener$onMemberExi.call(listener, {
            roomId: params.roomId,
            participant: params.participant,
            roomName: params.roomName
          });
        ...
        case 'onRemovedFromChatRoom':
          (_listener$onMemberRem = listener.onMemberRemoved) === null || _listener$onMemberRem === void 0 || _listener$onMemberRem.call(listener, {
            roomId: params.roomId,
            participant: params.participant,
            roomName: params.roomName,
        ...
        case 'onMuteListAdded':
          {
            ...
            if (hasKV) {
              var _listener$onMuteListA;
              (_listener$onMuteListA = listener.onMuteListAddedV2) === null || _listener$onMuteListA === void 0 || _listener$onMuteListA.call(listener, {
                roomId: params.roomId,
                mutes: params.muteKVs
              });
            } else {
              var _listener$onMuteListA2;
              (_listener$onMuteListA2 = listener.onMuteListAdded) === null || _listener$onMuteListA2 === void 0 || _listener$onMuteListA2.call(listener, {
                roomId: params.roomId,
                mutes: params.mutes,
        ...
        case 'onMuteListRemoved':
          (_listener$onMuteListR = listener.onMuteListRemoved) === null || _listener$onMuteListR === void 0 || _listener$onMuteListR.call(listener, {
            roomId: params.roomId,
            mutes: params.mutes
          });
          break;
        case 'onAdminAdded':
          (_listener$onAdminAdde = listener.onAdminAdded) === null || _listener$onAdminAdde === void 0 || _listener$onAdminAdde.call(listener, {
            roomId: params.roomId,
            admin: params.admin
          });
          break;
        case 'onAdminRemoved':
          (_listener$onAdminRemo = listener.onAdminRemoved) === null || _listener$onAdminRemo === void 0 || _listener$onAdminRemo.call(listener, {
            roomId: params.roomId,
            admin: params.admin
          });
          break;
        case 'onOwnerChanged':
          (_listener$onOwnerChan = listener.onOwnerChanged) === null || _listener$onOwnerChan === void 0 || _listener$onOwnerChan.call(listener, {
            roomId: params.roomId,
        ...
        case 'onAnnouncementChanged':
          (_listener$onAnnouncem = listener.onAnnouncementChanged) === null || _listener$onAnnouncem === void 0 || _listener$onAnnouncem.call(listener, {
            roomId: params.roomId,
            announcement: params.announcement
          });
          break;
        case 'onAllowListAdded':
          (_listener$onAllowList = listener.onAllowListAdded) === null || _listener$onAllowList === void 0 || _listener$onAllowList.call(listener, {
            roomId: params.roomId,
            members: params.members
          });
          break;
        case 'onAllowListRemoved':
          (_listener$onAllowList2 = listener.onAllowListRemoved) === null || _listener$onAllowList2 === void 0 || _listener$onAllowList2.call(listener, {
            roomId: params.roomId,
            members: params.members
          });
          break;
        case 'onAllMemberMuteStateChanged':
          (_listener$onAllChatRo = listener.onAllChatRoomMemberMuteStateChanged) === null || _listener$onAllChatRo === void 0 || _listener$onAllChatRo.call(listener, {
            roomId: params.roomId,
            isAllMuted: params.isAllMuted
          });
          break;
        case 'onSpecificationChanged':
          (_listener$onSpecifica = listener.onSpecificationChanged) === null || _listener$onSpecifica === void 0 || _listener$onSpecifica.call(listener, new _ChatRoom.ChatRoom(params.room));
          break;
        case 'onAttributesUpdated':
          ...
          (_listener$onAttribute = listener.onAttributesUpdated) === null || _listener$onAttribute === void 0 || _listener$onAttribute.call(listener, {
            roomId: params.roomId,
        ...
        case 'onAttributesRemoved':
          (_listener$onAttribute2 = listener.onAttributesRemoved) === null || _listener$onAttribute2 === void 0 || _listener$onAttribute2.call(listener, {
            roomId: params.roomId,
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async joinChatRoomEx(params) {
    _ChatConst.chatlog.log(`${ChatRoomManager.TAG}: joinChatRoomEx: ${params}`);
    let r = await _Native.Native._callMethod(_Consts.MTjoinChatRoom, {
      [_Consts.MTjoinChatRoom]: {
        ...params
      }
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async fetchPublicChatRoomsFromServer(pageNum = 1, pageSize = 200) {
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async createChatRoom(subject, description, welcome, members, maxCount = 300) {
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async fetchChatRoomMembers(roomId, cursor = '', pageSize = 200) {
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async muteChatRoomMembers(roomId, muteMembers, duration = -1) {
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async fetchChatRoomMuteList(roomId, pageNum = 1, pageSize = 200) {
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async fetchChatRoomBlockList(roomId, pageNum = 1, pageSize = 200) {
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async isMemberInChatRoomMuteList(roomId) {
    _ChatConst.chatlog.log(`${ChatRoomManager.TAG}: isMemberInChatRoomMuteList: `, roomId);
    let r = await _Native.Native._callMethod(_Consts.MTisMemberInChatRoomMuteListFromServer, {
      [_Consts.MTisMemberInChatRoomMuteListFromServer]: {
        roomId
      }
    });
    ChatRoomManager.checkErrorFromResult(r);
    let ret = r === null || r === void 0 ? void 0 : r[_Consts.MTisMemberInChatRoomMuteListFromServer];
    return ret;
  }
