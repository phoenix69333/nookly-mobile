...
export class ChatContactManager extends BaseManager {
  ...
  invokeContactListener(params) {
    this._contactListeners.forEach(listener => {
      ...
      switch (contactEventType) {
        case 'onContactAdded':
          (_listener$onContactAd = listener.onContactAdded) === null || _listener$onContactAd === void 0 || _listener$onContactAd.call(listener, params.username);
          break;
        case 'onContactDeleted':
          (_listener$onContactDe = listener.onContactDeleted) === null || _listener$onContactDe === void 0 || _listener$onContactDe.call(listener, params.username);
          break;
        case 'onContactInvited':
          (_listener$onContactIn = listener.onContactInvited) === null || _listener$onContactIn === void 0 || _listener$onContactIn.call(listener, params.username, params.reason);
          break;
        case 'onFriendRequestAccepted':
          (_listener$onFriendReq = listener.onFriendRequestAccepted) === null || _listener$onFriendReq === void 0 || _listener$onFriendReq.call(listener, params.username);
          break;
        case 'onFriendRequestDeclined':
          (_listener$onFriendReq2 = listener.onFriendRequestDeclined) === null || _listener$onFriendReq2 === void 0 || _listener$onFriendReq2.call(listener, params.username);
          break;
        default:
   ...
   */
  async addContact(userId, reason = '') {
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async deleteContact(userId, keepConversation = false) {
