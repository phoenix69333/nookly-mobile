...
const ChatSdkModule = TurboModuleRegistry ? TurboModuleRegistry.get('ChatSdk') : NativeModules.ChatSdk;
export const ExtSdkApiRN = ChatSdkModule ? ChatSdkModule : new Proxy({}, {
  get() {
