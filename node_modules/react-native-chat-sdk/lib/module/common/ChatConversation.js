...
export class ChatConversation {
  ...
  async name() {
    if (this.convType === ChatConversationType.PeerChat) {
      const ret = await Factory.getChatClient().userManager.fetchUserInfoById([this.convId]);
      if (ret.size > 0) {
      ...
      const ret = await Factory.getChatClient().groupManager.fetchGroupInfoWithoutMembersFromServer(this.convId);
      if (ret) {
        return ret.groupName;
      }
    } else if (this.convType === ChatConversationType.RoomChat) {
      const ret = await Factory.getChatClient().roomManager.fetchChatRoomInfoFromServer(this.convId);
      if (ret) {
        return ret.roomName;
      }
    } else {
  ...
  async getUnreadCount() {
    return Factory.getChatClient().chatManager.getConversationUnreadCount(this.convId, this.convType, this.isChatThread);
  }
  ...
  async getMessageCount() {
    return Factory.getChatClient().chatManager.getConversationMessageCount(this.convId, this.convType, this.isChatThread);
  }
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async getMessageCountWithTimestamp(start, end) {
  ...
  async getLatestMessage() {
    return Factory.getChatClient().chatManager.getLatestMessage(this.convId, this.convType, this.isChatThread);
  }
  ...
  async getLatestReceivedMessage() {
    return Factory.getChatClient().chatManager.getLatestReceivedMessage(this.convId, this.convType, this.isChatThread);
  }
  ...
  async setConversationExtension(ext) {
    await Factory.getChatClient().chatManager.setConversationExtension(this.convId, this.convType, this.ext, this.isChatThread);
    this.ext = ext;
  }
  ...
  async markMessageAsRead(msgId) {
    return Factory.getChatClient().chatManager.markMessageAsRead(this.convId, this.convType, msgId, this.isChatThread);
  }
  ...
  async markAllMessagesAsRead() {
    return Factory.getChatClient().chatManager.markAllMessagesAsRead(this.convId, this.convType, this.isChatThread);
  }
  ...
  async updateMessage(msg) {
    ...
    return Factory.getChatClient().chatManager.updateConversationMessage(this.convId, this.convType, msg, this.isChatThread);
  }
  ...
  async deleteMessage(msgId) {
    return Factory.getChatClient().chatManager.deleteMessage(this.convId, this.convType, msgId, this.isChatThread);
  }
  ...
  async deleteMessagesWithTimestamp(params) {
    return Factory.getChatClient().chatManager.deleteMessagesWithTimestamp(this.convId, this.convType, params, this.isChatThread);
  }
  ...
  async deleteAllMessages() {
    return Factory.getChatClient().chatManager.deleteConversationAllMessages(this.convId, this.convType, this.isChatThread);
  }
   ...
   */
  async getMessagesWithMsgType(msgType, direction = ChatSearchDirection.UP, timestamp = -1, count = 20, sender) {
    return Factory.getChatClient().chatManager.getMessagesWithMsgType(this.convId, this.convType, msgType, direction, timestamp, count, sender, this.isChatThread);
  }
   ...
   */
  async getMessages(startMsgId, direction = ChatSearchDirection.UP, loadCount = 20) {
    return Factory.getChatClient().chatManager.getMessages(this.convId, this.convType, startMsgId, direction, loadCount, this.isChatThread);
  }
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async getMessagesWithIds(params) {
   ...
   */
  async getMessagesWithKeyword(keywords, direction = ChatSearchDirection.UP, timestamp = -1, count = 20, sender) {
    return Factory.getChatClient().chatManager.getMessagesWithKeyword(this.convId, this.convType, keywords, direction, timestamp, count, sender, this.isChatThread);
  }
   ...
   */
  async getMessageWithTimestamp(startTime, endTime, direction = ChatSearchDirection.UP, count = 20) {
    return Factory.getChatClient().chatManager.getMessageWithTimestamp(this.convId, this.convType, startTime, endTime, direction, count, this.isChatThread);
  }
  ...
  async removeMessagesFromServerWithMsgIds(msgIds) {
    return Factory.getChatClient().chatManager.removeMessagesFromServerWithMsgIds(this.convId, this.convType, msgIds, this.isChatThread);
  }
  ...
  async removeMessagesFromServerWithTimestamp(timestamp) {
    return Factory.getChatClient().chatManager.removeMessagesFromServerWithTimestamp(this.convId, this.convType, timestamp, this.isChatThread);
  }
  ...
  async getPinnedMessages() {
    return Factory.getChatClient().chatManager.getPinnedMessages(this.convId, this.convType, this.isChatThread);
  }
  ...
  async fetchPinnedMessages() {
    return Factory.getChatClient().chatManager.fetchPinnedMessages(this.convId, this.convType, this.isChatThread);
  }
   ...
   * @throws A description of the exception. See {@link ChatError}.
   */
  async removeMessagesWithTimestamp(params) {
