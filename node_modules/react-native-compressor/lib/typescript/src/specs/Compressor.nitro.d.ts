...
export interface Compressor extends HybridObject<{
    ...
    compress(fileUrl: string, optionMap: AnyMap, onProgress?: (progress: number) => void, onDownloadProgress?: (progress: number) => void): Promise<string>;
...
//# sourceMappingURL=Compressor.nitro.d.ts.map