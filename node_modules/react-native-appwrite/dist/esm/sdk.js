        ...
        this.realtime = {
            ...
            createSocket: () => {
                ...
                if (url !== this.realtime.url || // Check if URL is present
                    ...
                    this.realtime.socket = new WebSocket(url, undefined, {
                        headers: Object.assign({ Origin: `appwrite-${Platform.OS}://${this.config.platform}` }, (jwt && Platform.OS !== 'web' ? { 'x-appwrite-jwt': jwt } : {}))
                    });
                ...
                else if (((_d = this.realtime.socket) === null || _d === void 0 ? void 0 : _d.readyState) === WebSocket.OPEN) {
            ...
            sendSubscribeMessage: () => {
                ...
                this.realtime.subscriptions.forEach((sub, slot) => {
                    var _a;
                    const queries = (_a = sub.queries) !== null && _a !== void 0 ? _a : [];
                    const row = {
                ...
                this.realtime.socket.send(JSONbig$1.stringify({
                    type: 'subscribe',
                    data: rows
                }));
            },
                ...
                try {
                    ...
                    switch (message.type) {
                        case 'connected': {
                            ...
                            if (!session) {
                                const cookie = JSONbig$1.parse((_a = window.localStorage.getItem('cookieFallback')) !== null && _a !== void 0 ? _a : '{}');
                            ...
                            if (session && !(messageData === null || messageData === void 0 ? void 0 : messageData.user)) {
                                (_b = this.realtime.socket) === null || _b === void 0 ? void 0 : _b.send(JSONbig$1.stringify({
                                    type: 'authentication',
                                    data: {
                                        session
                                    }
                        ...
                        case 'response': {
                            ...
                            if ((action === null || action === void 0 ? void 0 : action.to) !== 'subscribe' || !Array.isArray(action.subscriptions)) {
                                break;
                            }
                            action.subscriptions.forEach((subscription, index) => {
                                const subscriptionId = subscription === null || subscription === void 0 ? void 0 : subscription.subscriptionId;
            ...
            try {
                ...
                if (data && typeof data === 'object') {
                    Object.defineProperty(data, 'toString', {
                        value: () => JSONbig$1.stringify(data),
                        writable: true,
                        enumerable: false,
                        configurable: true,
                    });
    ...
    createFile(paramsOrFirst, ...rest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (offset === 0) {
                ...
                const firstChunkHeaders = Object.assign(Object.assign({}, apiHeaders), { 'content-range': 'bytes 0-' + (firstChunkEnd - 1) + '/' + size });
                let firstChunk = yield FileSystem.readAsStringAsync(file.uri, {
                ...
                if (Platform.OS.toLowerCase() === 'android') {
                    ...
                    yield FileSystem.writeAsStringAsync(firstPath, firstChunk, { encoding: FileSystem.EncodingType.Base64 });
                }
                payload['file'] = { uri: firstPath, name: file.name, type: file.type };
                response = yield this.client.call('post', uri, firstChunkHeaders, payload);
            ...
            const uploadChunk = (chunk) => __awaiter(this, void 0, void 0, function* () {
                const chunkHeaders = Object.assign({}, apiHeaders);
                if (uploadId) {
                    chunkHeaders['x-appwrite-id'] = uploadId;
                }
                chunkHeaders['content-range'] = 'bytes ' + chunk.start + '-' + (chunk.end - 1) + '/' + size;
                const chunkData = yield FileSystem.readAsStringAsync(file.uri, {
                    encoding: FileSystem.EncodingType.Base64,
                ...
                if (Platform.OS.toLowerCase() === 'android') {
                    ...
                    yield FileSystem.writeAsStringAsync(chunkPath, chunkData, { encoding: FileSystem.EncodingType.Base64 });
                }
                const chunkPayload = Object.assign({}, payload);
                chunkPayload['file'] = { uri: chunkPath, name: file.name, type: file.type };
                const chunkResponse = yield this.client.call('post', uri, chunkHeaders, chunkPayload);
                if (failed) {
            ...
            return finalResponse !== null && finalResponse !== void 0 ? finalResponse : response;
        });
    }
...
class Realtime {
    ...
    startHeartbeat() {
        ...
        this.heartbeatTimer = window === null || window === void 0 ? void 0 : window.setInterval(() => {
            if (this.socket && this.socket.readyState === WebSocket.OPEN) {
                this.socket.send(JSONbig$1.stringify({ type: 'ping' }));
            }
                ...
                try {
                    ...
                    const socket = (this.socket = Platform.OS === 'web'
                        ...
                        : new WebSocketCtor(url, undefined, {
                            headers: Object.assign({ Origin: `appwrite-${Platform.OS}://${this.client.config.platform}` }, (jwt ? { 'x-appwrite-jwt': jwt } : {}))
                        }));
    ...
    sendUnsubscribeMessage(subscriptionIds) {
        ...
        this.socket.send(JSONbig$1.stringify({
            type: 'unsubscribe',
    ...
    handleResponseConnected(message) {
        ...
        if (session && !messageData.user) {
            (_b = this.socket) === null || _b === void 0 ? void 0 : _b.send(JSONbig$1.stringify({
                type: 'authentication',
                data: {
                    session
                }
