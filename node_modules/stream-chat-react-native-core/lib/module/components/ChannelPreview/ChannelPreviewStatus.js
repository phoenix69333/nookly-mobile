...
var _useMessageDeliveryStatus = require("./hooks/useMessageDeliveryStatus");
...
var ChannelPreviewStatus = exports.ChannelPreviewStatus = function ChannelPreviewStatus(props) {
  ...
  var created_at = latestMessagePreview == null ? void 0 : latestMessagePreview.created_at;
  ...
  return (0, _jsxRuntime.jsxs)(_reactNative.View, {
    ...
    children: [status === _useMessageDeliveryStatus.MessageDeliveryStatus.READ ? (0, _jsxRuntime.jsx)(_icons.CheckAll, Object.assign({
      pathFill: accent_blue
    }, checkAllIcon)) : status === _useMessageDeliveryStatus.MessageDeliveryStatus.DELIVERED ? (0, _jsxRuntime.jsx)(_icons.CheckAll, Object.assign({
      pathFill: grey
    }, checkAllIcon)) : status === _useMessageDeliveryStatus.MessageDeliveryStatus.SENT ? (0, _jsxRuntime.jsx)(_icons.Check, Object.assign({
      pathFill: grey
