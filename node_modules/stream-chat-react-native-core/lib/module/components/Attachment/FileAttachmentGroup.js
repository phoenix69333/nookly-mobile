  ...
  return (0, _jsxRuntime.jsx)(_reactNative.View, {
    ...
    children: filesToDisplay.map(function (file, index) {
      return (0, _jsxRuntime.jsx)(_reactNative.View, {
        ...
        children: ((0, _streamChat.isAudioAttachment)(file) || (0, _streamChat.isVoiceRecordingAttachment)(file)) && (0, _native.isSoundPackageAvailable)() ? (0, _jsxRuntime.jsx)(AudioAttachment, {
      ...
      }, `file-by-attachment-group-${message.id}-${index}`);
    })
  });
};
