...
var generateAttachmentAction = exports.generateAttachmentAction = function generateAttachmentAction(a) {
...
var generateImageUploadPreview = exports.generateImageUploadPreview = function generateImageUploadPreview(a) {
  return Object.assign({
    file: {
      uri: image_url
    },
...
var generateFileUploadPreview = exports.generateFileUploadPreview = function generateFileUploadPreview(a) {
  return Object.assign({
    file: Object.assign({
      name: 'dummy.pdf',
      type: 'file'
...
var generateCardAttachment = exports.generateCardAttachment = function generateCardAttachment(a) {
  return Object.assign({
    image_url: image_url,
...
var generateImgurAttachment = exports.generateImgurAttachment = function generateImgurAttachment() {
  return generateCardAttachment({
    type: 'imgur'
  });
};
var generateGiphyAttachment = exports.generateGiphyAttachment = function generateGiphyAttachment() {
  return generateCardAttachment({
    type: 'giphy'
  });
};
