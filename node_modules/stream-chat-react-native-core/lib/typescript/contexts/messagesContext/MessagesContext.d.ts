...
import type { Attachment, Channel, ChannelState, CommandSuggestion, DeleteMessageOptions, LocalMessage, MessageResponse } from 'stream-chat';
...
import type { getGroupStyles, GroupStyle, MessageGroupStylesParams } from '../../components/MessageList/utils/getGroupStyles';
...
export type MessagesContextValue = Pick<MessageContextValue, 'isMessageAIGenerated'> & {
    ...
    deleteMessage: (message: LocalMessage, optionsOrHardDelete?: boolean | DeleteMessageOptions) => Promise<void>;
