 ...
 */
export declare const createDeleteQuery: <T extends keyof Schema>(table: T, whereCondition: Partial<{ [k in TableColumnNames<T>]: TableColumnValue | TableColumnValue[]; }>) => PreparedQueries;
